...
export default function ChatWidget() {
  ...
  const [messages, setMessages] = useState([
    { role: "assistant", content: "Hi! I'm your SynapseLearn assistant. How can I help you accelerate your tech career today?" }
  ]);
          ...
          >
            ...
            <div className="bg-brandprimary text-white p-4 flex items-center justify-between shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm">SynapseLearn Support Bot</h4>
